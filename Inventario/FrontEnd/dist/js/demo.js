...
(function ($) {
  ...
  //    localStorage.setItem('InventarioTech:Demo:Mensaje', (Date.now()) + (15 * 60 * 1000))
  //    // eslint-disable-next-line no-alert
  //    alert('Usted esta entrando a un sistema en fase ALPHA')
  //  }
  //}, 1000)
  ...
  $container.append(
    '<h5>Inventario Tech</h5><hr class="mb-2"/>'
  )
